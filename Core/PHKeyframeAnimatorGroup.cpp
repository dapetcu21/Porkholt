...
void PHKeyframeAnimatorGroup::playSection(const string & name, const PHInvocation & callback, double seek)
{
...
void PHKeyframeAnimatorGroup::playSection(int section, const PHInvocation & callback, double seek)
{
    PHInvocation inv = callback;
    for (set<PHKeyframeAnimator*>::iterator i = keyframeAnimators.begin(); i != keyframeAnimators.end(); i++)
    {
