...
- (void)applicationDidFinishLaunching:(UIApplication *)application {
	...
	touchView = [[TouchController alloc] initWithNibName:@"TouchController" bundle:nil];
	[touchView setParent:networkView];
	[[[[tabBarController viewControllers] objectAtIndex:2] view] addSubview:[touchView view]];
