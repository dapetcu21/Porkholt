function(porkholt PH_APP_TARGET)
  ...
  if(PH_PLATFORM STREQUAL "iOS")
    ...
    if(PH_LIVEPAPERS_HAS_SETTINGS STREQUAL "Check")
      set(_PH_LIVEPAPERS_SETTINGS "<string>Check</string>")
    elseif(PH_LIVEPAPERS_HAS_SETTINGS)
      set(_PH_LIVEPAPERS_SETTINGS "<true/>")
    else()
      set(_PH_LIVEPAPERS_SETTINGS "<false/>")
    endif()
