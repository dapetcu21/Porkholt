...
# STL
if( ANDROID_DYNAMIC_STL )
 set( __stlExt "so" )
 set( __stlDesignation "shared")
elseif()
 set( __stlExt "a" )
 set( __stlDesignation "static")
endif()


if( ANDROID_USE_STLPORT )
 if( EXISTS "${__stlLibPath}/libstlport_${__stlDesignation}.${__stlExt}" )
  set( CMAKE_CXX_CREATE_SHARED_LIBRARY "<CMAKE_CXX_COMPILER> <CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES> \"${__stlLibPath}/libstlport_${__stlDesignation}.${__stlExt}\"")
  set( CMAKE_CXX_CREATE_SHARED_MODULE  "<CMAKE_CXX_COMPILER> <CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES> \"${__stlLibPath}/libstlport_${__stlDesignation}.${__stlExt}\"")
  if ( ANDROID_DYNAMIC_STL )
   __COPY_IF_DIFFERENT( "${__stlLibPath}/libstlport_${__stlDesignation}.${__stlExt}" "${LIBRARY_OUTPUT_PATH}/libstlport_${__stlDesignation}.${__stlExt}" )
  endif()
 endif()
else( ANDROID_USE_STLPORT )
 if( EXISTS "${__stlLibPath}/libgnustl_${__stlDesignation}.${__stlExt}" )
  __COPY_IF_DIFFERENT( "${__stlLibPath}/libgnustl_${__stlDesignation}.${__stlExt}" "${__ndklibspath}/libstdc++.${__stlExt}" )
 elseif( ANDROID_ARCH_NAME STREQUAL "arm" AND EXISTS "${__stlLibPath}/${CMAKE_SYSTEM_PROCESSOR}/thumb/libstdc++.${__stlExt}" )
  __COPY_IF_DIFFERENT( "${__stlLibPath}/${CMAKE_SYSTEM_PROCESSOR}/thumb/libstdc++.${__stlExt}" "${__ndklibspath}/libstdc++.${__stlExt}" )
 elseif( ANDROID_ARCH_NAME STREQUAL "arm" AND EXISTS "${__stlLibPath}/${CMAKE_SYSTEM_PROCESSOR}/libstdc++.${__stlExt}" )
  __COPY_IF_DIFFERENT( "${__stlLibPath}/${CMAKE_SYSTEM_PROCESSOR}/libstdc++.${__stlExt}" "${__ndklibspath}/libstdc++.${__stlExt}" )
 elseif( ANDROID_ARCH_NAME STREQUAL "arm" AND EXISTS "${__stlLibPath}/thumb/libstdc++.${__stlExt}" )
  __COPY_IF_DIFFERENT( "${__stlLibPath}/thumb/libstdc++.${__stlExt}" "${__ndklibspath}/libstdc++.${__stlExt}" )
 elseif( EXISTS "${__stlLibPath}/libstdc++.${__stlExt}" )
  __COPY_IF_DIFFERENT( "${__stlLibPath}/libstdc++.${__stlExt}" "${__ndklibspath}/libstdc++.${__stlExt}" )
 endif()

  if ( ANDROID_DYNAMIC_STL )
   __COPY_IF_DIFFERENT( "${__ndklibspath}/libstdc++.${__stlExt}" "${LIBRARY_OUTPUT_PATH}/libgnustl_${__stlDesignation}.${__stlExt}" )
  endif()
