if (NOT PH_FORK STREQUAL "1")
    ...
    foreach(ARCH ${ANDROID_ARCHS})
        ...
        exec(COMMAND ${CMAKE_COMMAND} ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_ARGS} -DANDROID_NATIVE_API_LEVEL=android-9 -DANDROID_STL=gnustl_shared -DANDROID_ABI=${ARCH} -DCMAKE_TOOLCHAIN_FILE=${PH_ENGINE_PATH}/scripts/android.toolchain.cmake -DPH_FORK=1
    ...
    function(invoke_make TARGET_NAME)
        ...
        foreach(ARCH ${ANDROID_ARCHS})
            set(OUTPUT_DIR ${CMAKE_CURRENT_BINARY_DIR}/${ARCH})
            set(CMD "${CMD} && cd \"${OUTPUT_DIR}\" && ${PH_MAKE} ")
        endforeach()
