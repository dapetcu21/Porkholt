...
dependencies. You need to have cmake, imagemagick or graphicsmagick and lua
installed. These can be installed using your distro's package manager.

For example:
Debian / Ubuntu:
  sudo apt-get install lua cmake graphicsmagick
OS X with Macports:
